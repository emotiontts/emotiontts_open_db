...
from espnet.nets.pytorch_backend.transformer.embedding import LayerNormPositionalEncoding
...
class Transformer(TTSInterface, torch.nn.Module):
    ...
    def add_arguments(parser):
        ...
        group.add_argument(
            ...
            help="Use trainable scaled positional encoding or layer normalization positional encoding"
    ...
    def __init__(self, idim, odim, args=None):
        ...
        Args:
            ...
            args (Namespace, optional):
                ...
                - use_scaled_pos_enc (str):
                    Whether to use trainable scaled positional encoding or layer normalization positional encoding.
                - use_batch_norm (bool):
        ...
        if self.use_scaled_pos_enc == "LN":
            pos_enc_class = (LayerNormPositionalEncoding)
        elif self.use_scaled_pos_enc == "scaled":
    ...
    def _reset_parameters(self, init_type, init_enc_alpha=1.0, init_dec_alpha=1.0):
        ...
        if self.use_scaled_pos_enc == "scaled":
